...
# FIXME: rename tool (and call sites)
...
def main():
    ...
    cmd += [
        ...
        '--out-metadata-json=' + os.path.join(outdir, 'duk_build_meta.json')  # FIXME
    ]
    ...
    if opts.separate_sources:
        ...
        cmd = [
            ...
            '--output-metadata', os.path.join(outdir, 'metadata.json')  # FIXME: naming
        ]
